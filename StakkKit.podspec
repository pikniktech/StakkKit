...
Pod::Spec.new do |s|
  s.name             = 'StakkKit'
  s.version          = '0.1.0'
  s.summary          = 'A short description of StakkKit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/StakkKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Derek' => 'derek@stakkfactory.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/StakkKit.git', :tag => s.version.to_s }
